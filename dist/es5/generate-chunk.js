    ...
    return function generateChunk(name) {
        return function generate(path) {
            ...
            if (isDef(invokedResult)) {
                return function () { return Promise.resolve(invokedResult); };
            }
            return function () {
                return __awaiter(this, void 0, void 0, function () {
                    var beforeStartResult, promise, startedResult, chunk, e_1, rejectedRes;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                beforeStartResult = invoke(pluginsMap.beforeStart, [path, name], undefined);
                                if (isDef(beforeStartResult)) {
                                    return [2 /*return*/, beforeStartResult];
                                }
                                promise = importFactory(path);
                                startedResult = invoke(pluginsMap.started, [path, name, promise], undefined);
                                if (isDef(startedResult)) {
                                    return [2 /*return*/, startedResult];
                                }
                                _a.label = 1;
                            case 1:
                                _a.trys.push([1, 3, , 4]);
                            ...
                            case 2:
                                chunk = _a.sent();
                                return [2 /*return*/, invoke(pluginsMap.resolved, [path, name, chunk], chunk)];
                            case 3:
                                e_1 = _a.sent();
                                rejectedRes = invoke(pluginsMap.rejected, [path, name, e_1], undefined);
                                if (isDef(rejectedRes)) {
                                    return [2 /*return*/, rejectedRes];
                                }
                                else {
                                    throw e_1;
                                }
